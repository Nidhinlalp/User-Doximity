...
class FeedbackProvider with ChangeNotifier {
  var feedback = FirebaseFirestore.instance.collection('feedback');
  final CollectionReference ratingsCollection =
      FirebaseFirestore.instance.collection('ratings');

  final String userId = FirebaseAuth.instance.currentUser!.uid;

  addFeedBack(diUid, rating) async {
    ...
    var user = await FirebaseFirestore.instance
        ...
        .get();
    final String userImage = user.data()!['profilePic'] ??
    ...
    final String userName = user.data()!['userName'] ?? 'User';
    final feedbackData = {
    ...
    log(rating.toString());
    var f = await feedback.doc(diUid).get();
    if (f.exists) {
      feedback.doc(diUid).update({
        'feedback': FieldValue.arrayUnion([feedbackData])
      });
    } else {
      feedback.doc(diUid).set({
        'feedback': FieldValue.arrayUnion([feedbackData])
      });
    }
  }
